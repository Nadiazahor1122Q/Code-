// header backdrops
  ...
  let config = {
    ...
    'jade':{
      ...
      transform_animation_time_base: 2,
      transform_animation_time_offset: .02,
      transform_animation_time_offset_direction: 'forwards',

      transform_animation_delay_time_base: .2,
      transform_animation_delay_time_offset: .02,
      transform_animation_delay_time_offset_direction: 'forwards',
    },
    ...
    'amp':{
      ...
      transform_animation_delay_time_base: .6,
      transform_animation_delay_time_offset: .02,
      transform_animation_delay_time_offset_direction: 'backwards',
    },
    ...
    'financial':{
      tag_name: 'polygon',
      animation_name: 'financial_transform_anim',
      transform_origin: 'center',

      // time it takes for animation applied to path to complete
      transform_animation_time_base: .5,
      transform_animation_time_offset: .02,
      transform_animation_time_offset_direction: 'forwards',

      // time before animation applied to path starts
      transform_animation_delay_time_base: .5,
      transform_animation_delay_time_offset: .03,
      transform_animation_delay_time_offset_direction: 'forwards',
    },
    ...
    'energy':{
      tag_name: 'polygon',
      animation_name: 'energy_transform_anim',
      transform_origin: 'center',
  ...
  document.addEventListener("DOMContentLoaded", add_animations(config));
