...
function color_hover(e){pointers[0].down=true;pointers[0].color=generateColor();pointers[0].moved=pointers[0].down;console.log(generateColor());pointers[0].dx=(e.clientX-pointers[0].x)*5.0;pointers[0].dy=(e.clientY-pointers[0].y)*5.0;pointers[0].x=e.clientX;pointers[0].y=e.clientY;}
function color_hover_with_XY(e,X,Y,speed){speed=speed||50;var i=0;while(i!=speed){pointers[0].down=true;pointers[0].color=generateColor();pointers[0].moved=pointers[0].down;pointers[0].dx=(e.clientX+X-pointers[0].x)*5.0;pointers[0].dy=(e.clientY+Y-pointers[0].y)*5.0;pointers[0].x=e.clientX+X;pointers[0].y=e.clientY+Y;i++;}}
